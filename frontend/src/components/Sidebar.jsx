...
function Sidebar() {
    ...
    <aside className="flex min-h-full w-64 flex-col border-r border-gray-200 bg-white transition-colors dark:border-[#1e4d2a] dark:bg-[#1f3325]">
      <div className="flex flex-1 flex-col gap-1 px-3 py-4">
        ...
        <a href="#" className="flex items-center gap-4 rounded-xl px-3 py-2.5 font-medium text-gray-700 transition-colors hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-white/10">
        ...
        {/* 20 Dummy Channels to test the scrolling! */}
        {[...Array(20)].map((_, index) => (
          <a key={index} href="#" className="flex items-center justify-between rounded-xl px-3 py-2 transition-colors hover:bg-gray-100 dark:hover:bg-white/10">
            <div className="flex items-center gap-3">
              <img src={`https://ui-avatars.com/api/?name=Channel+${index + 1}&background=random`} alt="Channel" className="h-6 w-6 rounded-full object-cover" />
              <span className="line-clamp-1 text-sm font-medium text-gray-700 dark:text-gray-200">Channel {index + 1}</span>
            </div>
